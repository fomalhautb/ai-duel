...
const ENTRIES: DevEntry[] = [
  ...
  },
  {
    path: '/hero',
    title: '选择英雄界面',
    desc: '照设计稿复原的选人页：七张人物卡分两排、金框选中态、hover 浮起和确认光效都在。纯 UI demo，选中的英雄不落存档也进不了对局，点「确认英雄」只播一段光效。',
  },
  {
    path: '/card',
    title: '卡牌图鉴 / 卡面调试',
  ...
  },
  {
    path: '/result',
    title: '结算界面调试',
    desc: '对局结束的结算底板：胜 / 负 / 平 / 中断四种结果随手切，比分可改，套在和对局同样的 16:9 舞台里，调版式不用真打完一局。',
  },
  {
    path: '/match',
    title: '测试对局',
