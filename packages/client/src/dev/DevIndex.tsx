...
const ENTRIES: DevEntry[] = [
  ...
  },
  {
    path: '/deck',
    title: '组建牌组 demo',
    desc: '卡池是存档里已拥有的真卡：圆圈加减、卡池和牌组之间拖拽、点开放大查看。这条独立入口点确认会写进本地存档，联机匹配后的选卡组那一步会拿它预填。',
  },
  {
    path: '/hero',
    title: '选择英雄界面',
    desc: '照设计稿复原的选人页：七张人物卡分两排、金框选中态、hover 浮起和确认光效都在。这条独立入口点确认会写进本地存档，联机匹配后的选英雄那一步会拿它预填。',
  },
  {
    path: '/card',
    title: '卡牌图鉴 / 卡面调试',
