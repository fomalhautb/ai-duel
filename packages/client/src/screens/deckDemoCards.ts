...
export const DECK_DEMO_CARDS: DeckDemoCard[] = [
  ...
  },
  {
    ...
    backText: '本轮内，双方后续打出的所有牌费用减少1点，最低降至1点。',
  },
  {
    id: 'far-ahead',
    faction: 'other',
    ...
    backText: '本轮立即结束，不进行 Agent 作答、答案判定和积分结算；已打出的牌和已支付的 Token 不返还。',
  },
  {
    ...
    backText: '双方场上所有不具备「国产」标签的 Agent 均被罚下并移入弃牌区。',
  },
  {
    id: 'version-rollback',
    faction: 'claude',
    ...
    backText: '选择场上1个可退化的 Agent，使其退化1级。',
  },
  {
    id: 'kids-mode',
    faction: 'kimi',
