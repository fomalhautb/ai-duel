 ...
 * 也就进不了牌组、上不了场，数值纯粹为了让卡面各个字段都有东西可画（弱点行、
 * 攻防行、翻面文案都得有非空的样例），没有任何平衡意义。
 * 真卡池落地后整个文件删掉，不要把这里的数值或命名迁过去。
 *
...
/**
 * 30 张 demo 卡：18 张 AI 卡（model）+ 12 张技能卡（prompt）。
 *
 * 每个阵营都同时有 AI 卡和技能卡，这样筛选栏点任何一个阵营都不会筛出空列表——
 * 演示页要能展示"筛完还有牌"的正常状态。
 *
 * weaknesses 只写大于 0 的维度：卡面那一行画的是"它哪里脆"，六维全列出来又长又没信息量
 * （HandCardFace 也会再过滤一道）。
 */
export const DECK_DEMO_CARDS: DeckDemoCard[] = [
  // ---- GPT ----
  {
    ...
    integrity: 2,
    text: '它会接话，但不保证接的是人话。',
    weaknesses: { hallucination: 3, forgetfulness: 3 },
  ...
  },
  {
    ...
    weaknesses: { hallucination: 2, overconfidence: 2, jailbreak: 2 },
  ...
  },
  {
    ...
    weaknesses: { overconfidence: 2, bias: 1, jailbreak: 1 },
  ...
  },
  {
    ...
    integrity: 5,
    text: '它算得比你快，也比你确信。',
    weaknesses: { overconfidence: 3, misjudgment: 1 },
  ...
  // ---- Claude ----
  {
    ...
    integrity: 2,
    text: '答得极快，代价是没来得及细想。',
    weaknesses: { forgetfulness: 2, misjudgment: 2 },
  ...
  },
  {
    ...
    weaknesses: { overconfidence: 2, misjudgment: 1 },
  ...
  },
  {
    ...
    weaknesses: { hallucination: 1, overconfidence: 2, bias: 1 },
  ...
  // ---- Kimi ----
  {
    ...
    weaknesses: { hallucination: 2, misjudgment: 2 },
  ...
  },
  {
    ...
    weaknesses: { jailbreak: 2, overconfidence: 2, bias: 1 },
  ...
  },
  {
    ...
    weaknesses: { overconfidence: 3, hallucination: 1 },
  ...
  // ---- DeepSeek ----
  {
    ...
    integrity: 4,
    text: '便宜、耐用、话不多。',
    weaknesses: { bias: 2, misjudgment: 1, forgetfulness: 1 },
  ...
  },
  {
    ...
    weaknesses: { overconfidence: 3, forgetfulness: 2 },
  ...
  },
  {
    ...
    weaknesses: { jailbreak: 2, hallucination: 2 },
  ...
  // ---- 国产通用 ----
  {
    ...
    integrity: 2,
    text: '一步一步来，只是有一步算错了。',
    weaknesses: { misjudgment: 3, forgetfulness: 1 },
  ...
  },
  {
    ...
    weaknesses: { hallucination: 2, bias: 1 },
