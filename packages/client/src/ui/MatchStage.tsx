...
/**
 * 出牌演出的兜底解锁时间（秒）。两条出牌链路（AI 卡飞向战场、技能牌中央亮相）共用。
 *
...
function BattleField({
   ...
   * 屏幕上有牌正在飞或刚落地，演出还没收尾。
   *
   * 三条链路共用这一个锁：我方出牌（AI 卡飞向战场并落地冒烟，技能牌在中央亮相）、
   ...
   * 已经易主给下一次演出了——比如联机时技能牌的兜底先到点放了锁，玩家立刻又打出一张 AI 卡，
  ...
  useGSAP(
    () => {
      ...
      gsap
        ...
        // 解锁同样只认自己这一次：连打两张技能牌时，上一条时间线到点也会跑到这儿，
